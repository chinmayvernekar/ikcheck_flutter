...
class ClearDataAccountScreen extends StatefulWidget {
  const ClearDataAccountScreen({Key? key}) : super(key: key);

  @override
  State<ClearDataAccountScreen> createState() => _ClearDataAccountScreenState();
}

class _ClearDataAccountScreenState extends State<ClearDataAccountScreen> {
          ...
          children: <Widget>[
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              "${LocaleKeys.ACCOUNT_CLEARDATA_PERMENENTLY.tr()}" +
                                  ' \n' +
                                  "${LocaleKeys.ACCOUNT_CLEARDATA_DELDATA.tr()}",
                      ...
                      child: RichText(
                        ...
                        text: TextSpan(
                          children: [
                            TextSpan(
                              text:
                                  '${LocaleKeys.ACCOUNT_CLEARDATA_WARNING.tr().toUpperCase()}: ',
                            ...
                            TextSpan(
                              text: LocaleKeys.ACCOUNT_CLEARDATA_WARNINGCONTENT
                                  .tr(),
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  LocaleKeys.ACCOUNT_CLEARDATA_DATA.tr(),
                  ...
                  Expanded(
                    child: SecondaryButton(
                      ...
                      ontap: () async {
                        ...
                        String res =
                            await ApiCallManagement().clearAccount(context);
                        if (res == 'SUCCESS') {
                          Map data =
                          ...
                          // Provider.of<MainProvider>(context, listen: false)
                          //     .setAccStrip(true, true,
                          //         LocaleKeys.ACCOUNT_DATACLEARED.tr());
                          Provider.of<MainProvider>(context, listen: false)
